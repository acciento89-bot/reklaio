...
export async function POST(_request: Request, context: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    if (result.rowCount === 0) {
      ...
      return redirectToManagement(id, "Der Fall ist bereits archiviert oder wurde nicht gefunden.");
    }
    ...
    return redirectToManagement(id, "Der Fall konnte gerade nicht archiviert werden.");
  } finally {
    client.release();
  }
}
